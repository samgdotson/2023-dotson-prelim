...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{figure}
            \centering
            % \resizebox{\columnwidth}{!}{\input{../docs/figures/standard-mga.pgf}}
            \resizebox{0.75\columnwidth}{!}{\input{images/naive_mga_lp.pgf}}
...
%             \centering
%             % \resizebox{\columnwidth}{!}{\input{../docs/figures/standard-mga.pgf}}
%             \resizebox{\columnwidth}{!}{\input{images/naive_mga_lp.pgf}}
%             \caption{Illustration of the MGA algorithm.}
%             \label{fig:standard-mga}
%         \end{figure}
%     \end{columns}
