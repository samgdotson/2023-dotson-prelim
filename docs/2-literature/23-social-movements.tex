...
framework is illustrated in Figure \ref{fig:risk-framework} Considering the
actions taken (or not) in response to climate change is important for a holistic
understanding of risk because it encompasses benefits and mitigating outcomes,
not just negative, inflammatory ones. Additionally, various stakeholders
perceive the costs and benefits of (in)action differently, and therefore,
...
\begin{enumerate}
    ...
    basic needs such as food, water, shelter; and also livelihood, and health.
...
this framework is also useful for assessing policies to mitigate climate change,
...
emissions \cite{roelfsema_taking_2020}. This gap, as well as the fundamental
assumptions about carbon sequestration from the 2015 Paris Agreement, suggests
...
\textit{impacts} are always done \textit{ex post facto}. Differences in
...
\cite{islam_climate_2017, dorkenoo_critical_2022}. In purely economic terms, the
loss of ecosystem services from land use change associated with climate change
and other human activities is estimated at \$4 - \$20 trillion per year (in 2011
...
klinenberg_heat_2003}. The risk assessment literature, as well as the energy
...
energy and environmental justice literature offer insights to contrast this
...
\begin{enumerate}
    \item Whether energy systems should be 100\% renewable or nuclear power and
