...
already harmed by social inequities \cite{islam_climate_2017}. Recent work from
...
\cite{paterson_community-based_2019, elmallah_frontlining_2022}, and national
level policies \cite{roelfsema_taking_2020, fawzy_strategies_2020}. Paterson and
...
\end{enumerate}
Despite this, only around five percent of these policies are considered robust
according to their consistency with the \ac{un} ``Race to Zero'' campaign
...
emissions \cite{roelfsema_taking_2020}. This gap and the fundamental assumptions
...
thereby increasing the electricity demand, even when accounting for efficiency
improvements
