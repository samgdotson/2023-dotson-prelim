...
\Acp{esom} have several possible purposes such as forecasting future quantities,
...
burdens. Table \ref{tab:esoms} summarizes the capabilities for a comprehensive
...
tolerance of the optimal value. Further, the solutions generated by \ac{mga}
